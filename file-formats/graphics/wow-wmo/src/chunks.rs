...
pub struct Modn {
    pub names: Vec<String>,
    /// Maps byte offset within the MODN blob to the string starting at that offset.
    /// Used to resolve `ModdEntry::name_index()`, which is a byte offset, not an array index.
